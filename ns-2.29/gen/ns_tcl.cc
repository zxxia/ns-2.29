...
\"\n\
checkout_executable TCLSH \"/tank/zxxia/ns-allinone-2.29/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/tank/zxxia/ns-allinone-2.29/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
Queue/DropTail2 set two_queue_      true ;# switch between 1-q/2-q\n\
Queue/DropTail2 set drop_front_     false\n\
Queue/DropTail2 set summarystats_   false\n\
Queue/DropTail2 set queue_in_bytes_ false\n\
Queue/DropTail2 set mean_pktsize_   500\n\
\n\
Queue/DropTail2/VcpQueue set encode_load_factor_        1 ;# testing\n\
Queue/DropTail2/VcpQueue set smoothen_load_factor_      0 ;# testing\n\
Queue/DropTail2/VcpQueue set queue_weight_              0.50\n\
Queue/DropTail2/VcpQueue set queue_sampling_interval_   0.010 ;# s\n\
Queue/DropTail2/VcpQueue set load_measurement_interval_ 0.200\n\
\n\
Agent/TCP/Reno/VcpSrc set windowOption_                10 ;# i.e., vcp\n\
Agent/TCP/Reno/VcpSrc set window_                90000000 ;# infinity\n\
Agent/TCP/Reno/VcpSrc set class_                        2\n\
Agent/TCP/Reno/VcpSrc set packetSize_                1000\n\
Agent/TCP/Reno/VcpSrc set encode_load_factor_               [expr [Queue/DropTail2/VcpQueue set encode_load_factor_]]\n\
Agent/TCP/Reno/VcpSrc set router_load_measurement_interval_ [expr [Queue/DropTail2/VcpQueue set load_measurement_interval_]]\n\
\n\
Agent/TCP/Reno/VcpSrc set k_     0.25\n\
Agent/TCP/Reno/VcpSrc set alpha_ 1.0\n\
Agent/TCP/Reno/VcpSrc set beta_  0.875\n\
Agent/TCP/Reno/VcpSrc set w_     1.0 ;# changeable\n\
\n\
Agent/TCP/Reno/VcpSrc set md_wait_timer_counter_ 0 ;# statistics\n\
Agent/TCP/Reno/VcpSrc set pacing_timer_counter_  0\n\
Agent/TCP/Reno/VcpSrc set runtime_counter_       0\n\
\n\
Agent/VcpSink set sport_    0\n\
Agent/VcpSink set dport_    0         \n\
Agent/VcpSink set packetSize_ 40\n\
Agent/VcpSink set maxSackBlocks_ 3\n\
Agent/VcpSink set ts_echo_bugfix_ true\n\
Agent/VcpSink set ts_echo_rfc1323_ false\n\
Agent/VcpSink set generateDSacks_ false\n\
Agent/VcpSink set qs_enabled_ false\n\
Agent/VcpSink set RFC2581_immediate_ack_ true\n\
Agent/VcpSink set bytes_ 0\n\
\n\
\n\
