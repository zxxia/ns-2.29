...
proc finish {} {
  ...
  $qlen_graph display
#  puts "\nevery\t[set K]th\t[set INT]s"
#  puts "[$ls0 get-percentile-packet-queue-length 10]\t\
#        [$ls1 get-percentile-packet-queue-length 10]\t\
#        [$ls2 get-percentile-packet-queue-length 10]"
#  puts "[$ls0 get-percentile-packet-queue-length 25]\t\
#        [$ls1 get-percentile-packet-queue-length 25]\t\
#        [$ls2 get-percentile-packet-queue-length 25]"
#  puts "[$ls0 get-percentile-packet-queue-length 50]\t\
#        [$ls1 get-percentile-packet-queue-length 50]\t\
#        [$ls2 get-percentile-packet-queue-length 50]"
#  puts "[$ls0 get-percentile-packet-queue-length 75]\t\
#        [$ls1 get-percentile-packet-queue-length 75]\t\
#        [$ls2 get-percentile-packet-queue-length 75]"
#  puts "[$ls0 get-percentile-packet-queue-length 90]\t\
#        [$ls1 get-percentile-packet-queue-length 90]\t\
#        [$ls2 get-percentile-packet-queue-length 90]"
  ...
  if { $n_tests == $n_tests_passed } {
    puts "\tPASSED all $n_tests tests on the RPIQueueMonitor."
  }
